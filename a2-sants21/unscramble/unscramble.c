...
int main(int argc, char **argv) {
    ...
    char **dict = malloc(MAX_LENGTH * sizeof(char *));
    char **sorted_dict = malloc(MAX_LENGTH * sizeof(char * ));
    char **jumbles = malloc(MAX_LENGTH * sizeof(char *));
    char **sorted_jumbles = malloc(MAX_LENGTH * sizeof(char * ));
